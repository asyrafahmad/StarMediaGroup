...
<div class="container" style="max-width:400px;margin:10px auto;padding:2rem;border:1px solid #ddd;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.1)">
    ...
    <form action="{{ route('register') }}" method="POST" style="margin-top:0.5rem;">
        ...
        <br>
        <button type="submit" style="width:100%;padding:0.75rem;background-color:#da2128;color:#fff;border:none;border-radius:4px;font-weight:600;cursor:pointer;">
            Register
        </button>

        <p style="text-align:center;margin-top:1rem;">
            Already have an account?
            <a href="{{ route('login') }}" style="color:#da2128;text-decoration:none;">Login here</a>
        </p>
    </form>
</div>
@endsection
